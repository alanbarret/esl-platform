...
SIGN_POSES = {
    # HELLO: right arm raised to shoulder height, hand open, slight wave
    "HELLO":     {"RightArm":(-0.5,0,0.5),"RightForeArm":(0,0,0.5),"RightHand":(0.3,0,0)},

    # THANK_YOU: flat hand moves forward from chin
    "THANK_YOU": {"RightArm":(-0.4,0,0.3),"RightForeArm":(0,0,0.3),"RightHand":(0.4,0,0),"Head":(0.08,0,0)},

    # YES: fist nods (head nod)
    "YES":       {"RightArm":(-0.2,0,0.2),"RightForeArm":(0,0,0.2),"Head":(0.15,0,0)},

    # NO: index finger wags side to side (head shake)
    "NO":        {"RightArm":(-0.2,0,0.2),"RightForeArm":(0,0,0.3),"RightHandIndex1":(-0.5,0,0),"Head":(0,0.2,0)},

    # HOW: both palms up, shoulder height
    "HOW":       {"RightArm":(-0.4,0,0.4),"RightForeArm":(0,0,0.4),"LeftArm":(-0.4,0,-0.4),"LeftForeArm":(0,0,-0.4)},

    # YOU: point finger forward at person
    "YOU":       {"RightArm":(-0.5,0,0.2),"RightForeArm":(0,0,0.5),"RightHandIndex1":(-0.6,0,0)},

    # I: thumb points to chest
    "I":         {"RightArm":(-0.3,0,0.1),"RightForeArm":(0,0,0.2),"RightHandThumb1":(0,0,-0.7)},

    # GOOD: flat hand out from chin forward
    "GOOD":      {"RightArm":(-0.4,0,0.3),"RightForeArm":(0,0,0.4),"RightHand":(0.2,0,0)},

    # PLEASE: circular motion on chest
    "PLEASE":    {"RightArm":(-0.3,0,0.2),"RightForeArm":(0,0,0.3),"RightHand":(0.6,0,0)},

    # HELP: one fist supported by other open palm, lift up
    "HELP":      {"RightArm":(-0.3,0,0.2),"RightForeArm":(0,0,0.3),"LeftArm":(-0.3,0,-0.2),"LeftForeArm":(0,0,-0.3)},

    # WELCOME: both arms open outward
    "WELCOME":   {"RightArm":(-0.3,0,0.5),"RightForeArm":(0,0,0.3),"LeftArm":(-0.3,0,-0.5),"LeftForeArm":(0,0,-0.3)},

    # GOODBYE: wave, hand at head height
    "GOODBYE":   {"RightArm":(-0.5,0,0.5),"RightForeArm":(0,0,0.4),"RightHand":(0,0.3,0)},

    # MORNING: arm sweeps up from waist to shoulder
    "MORNING":   {"RightArm":(-0.4,0,0.4),"RightForeArm":(0,0,0.3)},

    # EVENING: arm sweeps down
    "EVENING":   {"RightArm":(-0.2,0,0.2),"RightForeArm":(0,0,0.2)},

    # SORRY: fist circles on chest
    "SORRY":     {"RightArm":(-0.3,0,0.15),"RightForeArm":(0,0,0.25),"RightHand":(0.4,0,0),"Head":(0.08,0,0)},

    # WHERE: index finger wagging
    "WHERE":     {"RightArm":(-0.4,0,0.3),"RightForeArm":(0,0,0.4),"RightHandIndex1":(-0.4,0,0),"Head":(0,0.1,0)},

    # WHAT: palms up, shrug
    "WHAT":      {"RightArm":(-0.3,0,0.3),"RightForeArm":(0,0,0.3),"LeftArm":(-0.3,0,-0.3),"Spine2":(0.05,0,0)},

    # WHO: index finger circles near chin
    "WHO":       {"RightArm":(-0.3,0,0.2),"RightForeArm":(0,0,0.3),"RightHandIndex1":(-0.4,0,0)},

    # NEED: bent index points down
    "NEED":      {"RightArm":(-0.2,0,0.2),"RightForeArm":(0,0,0.3),"RightHandIndex1":(-0.5,0,0)},

    # WANT: fingers pull toward body
    "WANT":      {"RightArm":(-0.3,0,0.2),"RightForeArm":(0,0,0.4),"LeftArm":(-0.3,0,-0.2),"LeftForeArm":(0,0,-0.4)},

    # WATER: W handshape taps chin
    "WATER":     {"RightArm":(-0.4,0,0.2),"RightForeArm":(0,0,0.3),"RightHandIndex1":(-0.3,0,0),"RightHandMiddle1":(-0.3,0,0),"RightHandRing1":(-0.3,0,0)},

    # FOOD: fingers pinch to lips
    "FOOD":      {"RightArm":(-0.5,0,0.2),"RightForeArm":(0,0,0.5),"RightHandThumb1":(0,0,-0.4)},

    # DOCTOR: D taps wrist
    "DOCTOR":    {"RightArm":(-0.3,0,0.15),"RightForeArm":(0,0,0.3),"RightHandIndex1":(-0.3,0,0)},

    # HOME: fingers touch cheek then chin
    "HOME":      {"RightArm":(-0.5,0,0.2),"RightForeArm":(0,0,0.5),"RightHand":(0.3,0,0)},

    # WORK: fists hit together
    "WORK":      {"RightArm":(-0.3,0,0.2),"RightForeArm":(0,0,0.4),"LeftArm":(-0.3,0,-0.2),"LeftForeArm":(0,0,-0.4)},

    # NAME: H taps other H
    "NAME":      {"RightArm":(-0.3,0,0.2),"RightForeArm":(0,0,0.4),"RightHandIndex1":(-0.3,0,0),"RightHandMiddle1":(-0.3,0,0)},

    "MY":        {"RightArm":(-0.2,0,0.1),"RightForeArm":(0,0,0.2),"RightHand":(0.5,0,0)},
    "MY_NAME":   {"RightArm":(-0.3,0,0.2),"RightForeArm":(0,0,0.3),"RightHand":(0.4,0,0)},
    "VERY_MUCH": {"RightArm":(-0.3,0,0.3),"RightForeArm":(0,0,0.3),"RightHandThumb1":(0,0,-0.6),"Head":(0.08,0,0)},
    "AM":        {"RightArm":(-0.2,0,0.1),"RightForeArm":(0,0,0.2)},
}

DEFAULT_POSE = {"RightArm":(-0.3,0,0.2),"RightForeArm":(0,0,0.3),"RightHand":(0.2,0,0)}
