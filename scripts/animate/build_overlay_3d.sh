...
OUT="/root/.openclaw/workspace/arab_sheik_${WORD}_overlay3d.mp4"

# Same trim logic as build_overlay.sh
...
python3 scripts/animate/overlay_landmarks_3d.py "$AV" "$SRC" "$HOL" "$BONES" "$OUT" --trim-start "$TRIM_START"
ls -la "$OUT"
